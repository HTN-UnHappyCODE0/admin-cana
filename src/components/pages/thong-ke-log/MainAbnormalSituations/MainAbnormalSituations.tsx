                ...
                <DataWrapper data={listTest} loading={false}>
                    <Table
                        ...
                        column={[
                            ...
                            {
                                title: 'Mã tình huống',
                                render: (data: any) => <p className={clsx(styles.status, { [styles.create]: true }, styles.linkdetail)}>Tạo phiếu cân</p>,
                            },
                            {
                                title: 'Mã lựa chọn',
                            ...
                            {
                                title: 'Hành động',
                                render: (data: any) => data === STATUS_SITUATIONS.CHUA_KIEM_DUYET
                                    ? <Interact
