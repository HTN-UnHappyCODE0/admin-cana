...
function ChartExportCompany({}: PropsChartExportCompany) {
	...
	useQuery([QUERY_KEY.thong_ke_tong_hang_xuat, partnerUuid, context?.companyUuid, isShowBDMT, storageUuid, date], {
		queryFn: () =>
			httpRequest({
				isData: true,
	...
	return (
		<div className={styles.container}>
			<div className={styles.head}>
				<h3>Biểu đồ thống kê hàng xuất của tổng công ty</h3>
				<div className={styles.filter}>
					...
					<SelectFilterOption
						...
						placeholder='Tất cả công ty xuất'
					/>
