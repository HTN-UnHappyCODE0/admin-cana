...
function ChartServiceCompany({}: PropsChartServiceCompany) {
	...
	useQuery([QUERY_KEY.thong_ke_tong_hang_dich_vu, partnerUuid, context?.companyUuid, isShowBDMT, storageUuid, date], {
		queryFn: () =>
			httpRequest({
				isData: true,
	...
	return (
		<div className={styles.container}>
			<div className={styles.head}>
				<h3>Biểu đồ thống kê hàng dịch vụ của tổng công ty</h3>
