...
function ChartImportCompany({}: PropsChartImportCompany) {
	...
	const data = [
		{
			name: '21/07/2024',
			'Tổng khối lượng nhập hàng': 4000,
		},
		{
			name: '22/07/2024',
			'Tổng khối lượng nhập hàng': 3000,
		},
		{
			name: '23/07/2024',
			'Tổng khối lượng nhập hàng': 2000,
		},
		{
			name: '24/07/2024',
			'Tổng khối lượng nhập hàng': 2780,
		},
		{
			name: '25/07/2024',
			'Tổng khối lượng nhập hàng': 1890,
		},
		{
			name: '26/07/2024',
			'Tổng khối lượng nhập hàng': 2390,
		},
		{
			name: '27/07/2024',
			'Tổng khối lượng nhập hàng': 3490,
		},
	];
			...
			<div className={styles.main_chart}>
				<ResponsiveContainer width='100%' height='100%'>
					...
					>
						...
						<Bar dataKey='Tổng khối lượng nhập hàng' fill='#2A85FF' />
					</BarChart>
				</ResponsiveContainer>
			</div>
		</div>
