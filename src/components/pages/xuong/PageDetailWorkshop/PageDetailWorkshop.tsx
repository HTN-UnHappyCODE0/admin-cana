	...
	return (
		<div className={styles.container}>
			...
			<Dialog
				...
				title={
					detailCustomer?.status == CONFIG_STATUS.HOAT_DONG
						? `Khóa ${TYPE_PARTNER.KH_XUAT === Number(_typeCus)
							? 'khách hàng'
							: TYPE_PARTNER.KH_DICH_VU === Number(_typeCus)
								? 'khách hàng'
								: TYPE_PARTNER.NCC === Number(_typeCus)
						...
						: `Mở khóa ${TYPE_PARTNER.KH_XUAT === Number(_typeCus)
							? 'khách hàng'
							: TYPE_PARTNER.KH_DICH_VU === Number(_typeCus)
								? 'khách hàng'
								: TYPE_PARTNER.NCC === Number(_typeCus)
				...
				note={
					detailCustomer?.status == CONFIG_STATUS.HOAT_DONG
						? `Bạn có chắc chắn muốn khóa ${TYPE_PARTNER.KH_XUAT === Number(_typeCus)
							? 'khách hàng'
							: TYPE_PARTNER.KH_DICH_VU === Number(_typeCus)
								? 'khách hàng'
								: TYPE_PARTNER.NCC === Number(_typeCus)
						...
						: `Bạn có chắc chắn muốn mở khóa ${TYPE_PARTNER.KH_XUAT === Number(_typeCus)
							? 'khách hàng'
							: TYPE_PARTNER.KH_DICH_VU === Number(_typeCus)
								? 'khách hàng'
								: TYPE_PARTNER.NCC === Number(_typeCus)
